...
public class DetailViewExampleWithVideoBackgroundExoPlayerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            DetailViewExampleWithVideoBackgroundExoPlayerFragment fragment =
                    new DetailViewExampleWithVideoBackgroundExoPlayerFragment();
